...
/* ------ 統一カラーパレット ------ */
:root{
  --c-card-bg:      #fffdf7;      /* ほんのり暖色のオフホワイト（背景と馴染みつつ埋もれない） */
  --c-field-bg:     #fff8ef;      /* 入力欄のやわらかクリーム */
  --c-field-border: #f0ddc7;      /* 入力欄の枠：淡いベージュ */
  --c-text-main:    #5c5347;      /* 落ち着いたブラウン系テキスト */
  --c-accent:       #deb887;     /* タイトル＆ボタンのサーモンオレンジ */
  --c-accent-dark:  #f5deb3;      /* ボタン影など濃いめサーモン */
...
<body>
	...
	<div class="form">
		<div class="form_title">利用者新規登録</div>
